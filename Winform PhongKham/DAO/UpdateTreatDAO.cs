...
{
    public class UpdateTreatDAO
    {
        public static UpdateTreatDAO instance;
        public static UpdateTreatDAO Instance
        {
            get { if (instance == null) instance = new UpdateTreatDAO(); return instance; }
            private set { UpdateTreatDAO.instance = value; }
        }
        private UpdateTreatDAO() { }
        ...
        {
            return DataProvider.Instance.ExecuteQuery
                ("exec LoadToothPatient '" + idPatient + "', '" + date + "'");
        }
        public DataTable LoadDirectoryExcept(string idPatient, string date)
        {
            return DataProvider.Instance.ExecuteQuery
                ("exec LoadDirectoryExcept '" + idPatient + "', '" + date + "'");
        }
        public string getNameDentist(string idPatient, string date)
        {
            return DataProvider.Instance.ExecuteScalar
                ("select [dbo].[getNameDentist]('" + idPatient + "', '" + date + "')").ToString();
        }
        public string getNameAssistant(string idPatient, string date)
        {
            return DataProvider.Instance.ExecuteScalar
                ("select [dbo].[getNameAssistant]('" + idPatient + "', '" + date + "')").ToString();
        }
    }
}
